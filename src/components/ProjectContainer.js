            ...
            <div className="flex lg:pl-10 lg:pt-4 mb-5 pb-4 flex-col grid lg:justify-items-end lg:overflow-y-scroll">
                ...
                <div className="flex flex-col bg-slate-500 lg:w-2/3 p-8 shadow shadow-slate-900 mb-10 lg:mb-5 mr-5">
                    ...
                    <div className="lg:p-y-2 pt-3">
                        ...
                        <p className="text-4xl lg:text-base text-gray-900 w-3/4 text-justify w-full">My Carbon Footprint was created to give you a fun and easy way to get a snapshot of your personal carbon footprint. The app takes a look at some of the most common carbon emitting activities and provides you the ability to fill in your personal details and receive an estimate of carbon emissions based on data provided by the Carbon Interface REST API. </p>
                        <div className="flex flex-col lg:flex-row mt-3 items-center lg:justify-center">
                            <p className="text-4xl lg:text-base font-semibold text-gray-800">Technoligies:</p>
                ...
                <div className="bg-slate-500 lg:w-2/3 p-8 shadow shadow-slate-900 mr-5">
                    ...
                    <div className="lg:p-y-2 pt-3">
                        ...
                        <p className="text-4xl lg:text-base text-gray-900 w-3/4 text-justify w-full">I am interested in three.js and continuing to learn and add to this project. The demo is availabe <NavLink to="/threeproject" className="font-semibold cursor-pointer text-slate-300">here</NavLink>, where you can use the arrow keys on the keyboard to drive around in the world I am slowly expanding on and updating as I learn new Three.js skills.</p>
                        <div className="flex flex-col lg:flex-row mt-3 items-center lg:justify-center">
                            <p className="text-4xl lg:text-base font-semibold text-gray-800">Technoligies:</p>

        ...
        <div className="flex flex-col lg:flex-row ml-10 h-full w-screen lg:space-x-10">
            <div className="flex flex-col lg:w-1/3 items-center lg:fixed lg:pt-20 pt-10 lg:z-10">
                ...
                <div className="flex space-x-5 mt-5">
                    <span>
                        <a href="https://github.com/katroll" className="link" target="_blank" rel="noreferrer">
                            <svg
                    ...
                    <span>
                        <a href="https://www.linkedin.com/in/katherine-roll-82b157205/" className="link" target="_blank" rel="noreferrer">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="32"
                                height="32"
                    ...
                    <span>
                        <a href="mailto:kroll256@gmail.com">
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" 
                                width="32" 
                                height="32" 
